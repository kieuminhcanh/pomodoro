<template>
  <div class="flex h-5/6 flex-col justify-center items-center relative">
    ...
    <div class="w-4 h-full bg-gray-700 hand">
      <div class="absolute top-10 left-1/2 -translate-x-1/2 w-2 h-2/5 rounded-full brightness-200"
        :style="{ backgroundColor: color }"></div>
    </div>

    <div class="absolute top-1/2 -translate-y-1/2 w-3 h-3 outline outline-4 outline-cyan-500 rounded-full"></div>
  </div>
</template>
